...
export const CriarAnuncio = () => {
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        <div className="lg:col-span-2">
          <Card className="bg-white dark:bg-gray-900 p-8 border border-gray-200 dark:border-gray-800">
    ...
    <div className="lg:col-span-1">
      <Card className="bg-white dark:bg-gray-900 p-6 sticky top-8 border border-gray-200 dark:border-gray-800">
